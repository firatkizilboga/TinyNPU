...
from run_cv32e40p_prefill_attention_jit_demo import build_artifact  # noqa: E402
...
def main() -> int:
    ...
    program_name = (
        f"cv32e40p_prefill_attention_cpu_only_d{args.d_model}"
        f"_h{args.d_head}_t{args.token_count}_s{args.seed}"
    )
