...
from tinynpu_jit.rtl_runner import (  # noqa: E402
    ...
    render_runner_source as _runner_source,
    run_checked as _run,
    run_vlt_npu,
    sanitize_program_symbol as _sanitize,
    toolchain_prefix as _toolchain_prefix,
    toolchain_root as _toolchain_root,
)

# Compatibility shim: shared build/run/RTL helpers now live in tinynpu_jit.rtl_runner.
