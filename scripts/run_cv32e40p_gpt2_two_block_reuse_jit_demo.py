...
def _add_prefill_block(
    ...
    *,
    ...
    builder.add_tensor(TensorSpec(f"{prefix}_scores_f", (prompt_len, prompt_len), DType.FLOAT32, TensorKind.INTERMEDIATE))
    ...
    builder.host(f"{prefix}_scale_scores", "mul", inputs=[f"{prefix}_scores_f", f"{prefix}_score_scale"], outputs=[f"{prefix}_scores_scaled"])
