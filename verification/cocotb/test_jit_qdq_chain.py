...
from software.workload.jit_qdq_chain import build_qdq_chain_artifact


@cocotb.test()
async def test_jit_qdq_chain(dut):
    ...
    test_case = build_qdq_chain_artifact()
    ...
    assert "scores_q" in result.verified
