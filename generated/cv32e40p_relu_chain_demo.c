...
static int32_t h_data[16] __attribute__((section(".noinit")));

static TinyTensor h = {"h", h_data, TINY_DTYPE_INT16, 2, {4, 4, 1, 1}, 16};

static int32_t h_relu_data[16] __attribute__((section(".noinit")));
...
static int32_t y_data[16] __attribute__((section(".noinit")));
...
int main(void)
{
    ...
    printf("TinyNPU bare-metal program: cv32e40p_relu_chain_demo\n");
    ...
    cycle_t1 = read_mcycle32();
    print_cycle_delta32("preload.im_segment_001", cycle_t0, cycle_t1);
    ...
    cycle_t0 = read_mcycle32();
    read_tensor_from_npu(&h, 0x0010u, "C", 2);
    cycle_t1 = read_mcycle32();
    ...
    host_relu(&h_relu, &h);
    cycle_t1 = read_mcycle32();
    print_cycle_delta32("hostop.relu_h", cycle_t0, cycle_t1);
    printf("NpuSegment: segment_001\n");
    cycle_segment_t0 = read_mcycle32();
    cycle_t0 = read_mcycle32();
    write_tensor_to_npu(&h_relu, 0x0010u, "A", 2, 8);
    cycle_t1 = read_mcycle32();
    print_cycle_delta32("segment.segment_001.stage", cycle_t0, cycle_t1);
    cycle_t0 = read_mcycle32();
    if (npu_run(0x8004u) != 0) return EXIT_FAILURE;
    cycle_t1 = read_mcycle32();
    print_cycle_delta32("segment.segment_001.run", cycle_t0, cycle_t1);
    cycle_t0 = read_mcycle32();
    read_tensor_from_npu(&y, 0x0018u, "C", 2);
    cycle_t1 = read_mcycle32();
    print_cycle_delta32("segment.segment_001.readback", cycle_t0, cycle_t1);
    print_cycle_delta32("segment.segment_001.npu", cycle_segment_t0, cycle_t1);
