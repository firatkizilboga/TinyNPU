...
typedef enum {
    ...
    TNPU_HOST_RESHAPE = 7,
    TNPU_HOST_SLICE_ROW = 8,
    TNPU_HOST_TRANSPOSE = 9,
    TNPU_HOST_SOFTMAX = 10,
    TNPU_HOST_MEAN = 11,
    TNPU_HOST_MAXPOOL2D = 12,
    TNPU_HOST_AVGPOOL2D = 13,
    TNPU_HOST_ADAPTIVE_AVGPOOL2D = 14,
    TNPU_HOST_IM2COL = 15,
    TNPU_HOST_LAYOUT_RESTORE = 16,
    TNPU_HOST_RMSNORM = 17,
    TNPU_HOST_ROPE = 18,
    TNPU_HOST_SILU = 19,
    TNPU_HOST_MUL = 20,
    TNPU_HOST_ADD = 21,
    TNPU_HOST_SOFTMAX_F16 = 22,
    TNPU_HOST_K_CACHE_SCATTER_WRITE = 23,
    TNPU_HOST_CAUSAL_MASK = 24,
    TNPU_HOST_CONCAT_LASTDIM2 = 25,
    TNPU_HOST_LAYERNORM = 26,
    TNPU_HOST_V_CACHE_SCATTER_WRITE = 27,
    TNPU_HOST_K_CACHE_SCATTER_MATRIX = 28,
    TNPU_HOST_V_CACHE_SCATTER_MATRIX = 29,
    TNPU_HOST_LINEAR = 30,
    TNPU_HOST_CONV2D = 31,
    TNPU_HOST_FP16_TO_FLOAT32 = 32,
} TnpuHostKind;
